oApplication = { // Application is an object
	load : function(src, id, libs, resourceroots, bindingSyntax, theme,
			CacheBuster, callback) {
		var opts = {
		...
		setTimeout(this.loadSAPUI5(src, id, libs, resourceroots, bindingSyntax,
				theme, CacheBuster, callback));
	},

	loadSAPUI5 : function(src, id, libs, resourceroots, bindingSyntax, theme,
			CacheBuster, callback) {
	...
	onSAPUI5Loaded : function() {
		...
		$("body").fadeOut(
				...
				function() {
					...
					jQuery.sap.includeStyleSheet("css/smithfield.css",
							"smithfieldStyles");
